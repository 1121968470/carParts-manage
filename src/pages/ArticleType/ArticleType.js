...
import styles from './ArticleType.less';
...
@connect(({ articleType, loading }) => ({
  articleType,
  loading: loading.models.articleType,
}))
@Form.create()
class ArticleType extends PureComponent {
  state = {
    modalVisible: false,
